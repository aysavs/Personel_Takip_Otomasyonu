...
namespace Personel_Takip_Otomasyonu
{
    public partial class Form1 : Form
    {
        ...
        OracleConnection connection = new OracleConnection("User Id=SYSTEM;Password=parola;Data Source=192.168.1.108:1521/XEPDB1;");
        ...
        private void button1_Click(object sender, EventArgs e)
        {
            if (hak != 0)
            {
                ...
                while (kayitokuma.Read())
                {
                    ...
                    {
                        if (kayitokuma["kullaniciadi"].ToString() == textBox1.Text && kayitokuma["parola"].ToString
                            () == textBox2.Text && kayitokuma["yetki"].ToString() == "Personel")
                        {
                            durum = true;
                            tcno = kayitokuma.GetValue(0).ToString();
                            adi = kayitokuma.GetValue(1).ToString();
